...
#define CYGPKG_HAL_I386 v3_0
#define CYGPKG_HAL_I386_v3_0
#define CYGNUM_HAL_I386_VERSION_MAJOR 3
#define CYGNUM_HAL_I386_VERSION_MINOR 0
#define CYGNUM_HAL_I386_VERSION_RELEASE -1
#define CYGPKG_HAL_I386_GENERIC v3_0
#define CYGPKG_HAL_I386_GENERIC_v3_0
#define CYGNUM_HAL_I386_GENERIC_VERSION_MAJOR 3
#define CYGNUM_HAL_I386_GENERIC_VERSION_MINOR 0
#define CYGNUM_HAL_I386_GENERIC_VERSION_RELEASE -1
#define CYGPKG_HAL_I386_PC v3_0
#define CYGPKG_HAL_I386_PC_v3_0
#define CYGNUM_HAL_I386_PC_VERSION_MAJOR 3
#define CYGNUM_HAL_I386_PC_VERSION_MINOR 0
#define CYGNUM_HAL_I386_PC_VERSION_RELEASE -1
#define CYGBLD_HAL_TARGET_H   <pkgconf/hal_i386.h>
#define CYGBLD_HAL_PLATFORM_H <pkgconf/hal_i386_pc.h>
#define CYG_HAL_STARTUP RAM
#define CYG_HAL_STARTUP_RAM
#define CYGHWR_MEMORY_LAYOUT_LDI <pkgconf/mlt_i386_pc_ram.ldi>
#define CYGHWR_MEMORY_LAYOUT_H <pkgconf/mlt_i386_pc_ram.h>
#define CYGPKG_HAL_I386_PCMB v3_0
#define CYGPKG_HAL_I386_PCMB_v3_0
#define CYGNUM_HAL_I386_PCMB_VERSION_MAJOR 3
#define CYGNUM_HAL_I386_PCMB_VERSION_MINOR 0
#define CYGNUM_HAL_I386_PCMB_VERSION_RELEASE -1
...
#define CYGPKG_DEVICES_WALLCLOCK_DALLAS_DS12887 v3_0
#define CYGPKG_DEVICES_WALLCLOCK_DALLAS_DS12887_v3_0
#define CYGNUM_DEVICES_WALLCLOCK_DALLAS_DS12887_VERSION_MAJOR 3
#define CYGNUM_DEVICES_WALLCLOCK_DALLAS_DS12887_VERSION_MINOR 0
#define CYGNUM_DEVICES_WALLCLOCK_DALLAS_DS12887_VERSION_RELEASE -1
#define CYGPKG_DEVICES_WALLCLOCK_I386_PC v3_0
#define CYGPKG_DEVICES_WALLCLOCK_I386_PC_v3_0
#define CYGNUM_DEVICES_WALLCLOCK_I386_PC_VERSION_MAJOR 3
#define CYGNUM_DEVICES_WALLCLOCK_I386_PC_VERSION_MINOR 0
#define CYGNUM_DEVICES_WALLCLOCK_I386_PC_VERSION_RELEASE -1
/***** PC RTC driver proc output start *****/
#define CYGDAT_DEVS_WALLCLOCK_DALLAS_12887_INL <cyg/io/devices_wallclock_i386_pc.inl>
#define CYGDAT_DEVS_WALLCLOCK_i386_PC_CFG <pkgconf/devices_wallclock_i386_pc.h>
/***** PC RTC driver proc output end  *****/
