...
#define CYGPKG_HAL_FRV v3_0
#define CYGPKG_HAL_FRV_v3_0
#define CYGNUM_HAL_FRV_VERSION_MAJOR 3
#define CYGNUM_HAL_FRV_VERSION_MINOR 0
#define CYGNUM_HAL_FRV_VERSION_RELEASE -1
#define CYGPKG_HAL_FRV_FRV400 v3_0
#define CYGPKG_HAL_FRV_FRV400_v3_0
#define CYGNUM_HAL_FRV_FRV400_VERSION_MAJOR 3
#define CYGNUM_HAL_FRV_FRV400_VERSION_MINOR 0
#define CYGNUM_HAL_FRV_FRV400_VERSION_RELEASE -1
#define CYGBLD_HAL_TARGET_H   <pkgconf/hal_frv.h>
#define CYGBLD_HAL_PLATFORM_H <pkgconf/hal_frv_frv400.h>
#define CYGBLD_HAL_PLF_DEFS_H <cyg/hal/frv400.h>
#define CYGBLD_HAL_PLATFORM_IO_H <cyg/hal/plf_io.h>
#define CYG_HAL_STARTUP ROM
#define CYG_HAL_STARTUP_ROM
#define CYGHWR_MEMORY_LAYOUT_LDI <pkgconf/mlt_frv_frv400_rom.ldi>
#define CYGHWR_MEMORY_LAYOUT_H <pkgconf/mlt_frv_frv400_rom.h>
