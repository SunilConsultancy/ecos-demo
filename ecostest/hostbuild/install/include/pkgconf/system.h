...
#define CYGPKG_HAL_SYNTH v3_0
#define CYGPKG_HAL_SYNTH_v3_0
#define CYGNUM_HAL_SYNTH_VERSION_MAJOR 3
#define CYGNUM_HAL_SYNTH_VERSION_MINOR 0
#define CYGNUM_HAL_SYNTH_VERSION_RELEASE -1
#define CYGBLD_HAL_TARGET_H   <pkgconf/hal_synth.h>
#define CYGPKG_HAL_SYNTH_I386 v3_0
#define CYGPKG_HAL_SYNTH_I386_v3_0
#define CYGNUM_HAL_SYNTH_I386_VERSION_MAJOR 3
#define CYGNUM_HAL_SYNTH_I386_VERSION_MINOR 0
