...
#define CYGPKG_HAL_SYNTH current
#define CYGPKG_HAL_SYNTH_current
#define CYGNUM_HAL_SYNTH_VERSION_MAJOR CYGNUM_VERSION_CURRENT
#define CYGNUM_HAL_SYNTH_VERSION_MINOR -1
#define CYGNUM_HAL_SYNTH_VERSION_RELEASE -1
#define CYGBLD_HAL_TARGET_H   <pkgconf/hal_synth.h>
#define CYGPKG_HAL_SYNTH_I386 current
#define CYGPKG_HAL_SYNTH_I386_current
#define CYGNUM_HAL_SYNTH_I386_VERSION_MAJOR CYGNUM_VERSION_CURRENT
#define CYGNUM_HAL_SYNTH_I386_VERSION_MINOR -1
#define CYGNUM_HAL_SYNTH_I386_VERSION_RELEASE -1
#define CYGBLD_HAL_PLATFORM_H <pkgconf/hal_synth_i386.h>
#define CYG_HAL_STARTUP ROM
#define CYG_HAL_STARTUP_ROM
#define CYGHWR_MEMORY_LAYOUT_LDI <pkgconf/mlt_synth_i386_rom.ldi>
#define CYGHWR_MEMORY_LAYOUT_H <pkgconf/mlt_synth_i386_rom.h>
